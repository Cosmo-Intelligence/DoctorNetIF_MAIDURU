namespace RISCommonLibrary.Lib.Msg.Common.ChangeSection
{
	...
	/// 転棟情報部
	/// </summary>
	public class ChangeSectionAggregate : AggregateNode
	{
			...
			: base(ChangeSectionNodeInfo.H2RCB_ROOT)
		{
			...
			PT_ID = AddChildNode(new DataNode(ChangeSectionNodeInfo.H2RCB_PT_ID));
			CHG_DATE = AddChildNode(new DataNode(ChangeSectionNodeInfo.H2RCB_CHG_DATE));
			IDO_KA_CD = AddChildNode(new DataNode(ChangeSectionNodeInfo.H2RCB_IDO_KA_CD));
			FILLER = AddChildNode(new DataNode(ChangeSectionNodeInfo.H2RCB_FILLER));
		}
		#endregion
	}
}
