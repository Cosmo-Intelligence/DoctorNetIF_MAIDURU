...
{
	public class HISRISOrderRequestInfoAggregate : AggregateNode
	{
		...
		/// コンストラクタ
		/// </summary>
		public HISRISOrderRequestInfoAggregate()
			: base(HISRISOrderRequestInfoNodeInfo.H2RREQUEST_ROOT)
		{
			...
			PT_ID = AddChildNode(new DataNode(HISRISOrderRequestInfoNodeInfo.H2RREQUEST_PT_ID));
			XX_KBN = AddChildNode(new DataNode(HISRISOrderRequestInfoNodeInfo.H2RREQUEST_XX_KBN));
			XX_SYBT = AddChildNode(new DataNode(HISRISOrderRequestInfoNodeInfo.H2RREQUEST_XX_SYBT));
			YK_DATE = AddChildNode(new DataNode(HISRISOrderRequestInfoNodeInfo.H2RREQUEST_YK_DATE));
			FILLER = AddChildNode(new DataNode(HISRISOrderRequestInfoNodeInfo.H2RREQUEST_FILLER));
