namespace RISCommonLibrary.Lib.Msg.Common.PatientRequest
{
	...
	/// 患者属性部
	/// </summary>
	public class PatientRequestAttributeAggregate : AggregateNode
	{
		...
		/// コンストラクタ
		/// </summary>
		public PatientRequestAttributeAggregate()
			: base(HISRTPatientRequestInfo.REQUEST_PATIENT_ROOT)
		{
			...
			PT_ID = AddChildNode(new DataNode(HISRTPatientRequestInfo.H2RREQUEST_PT_ID));
		}
		#endregion
	}
}
