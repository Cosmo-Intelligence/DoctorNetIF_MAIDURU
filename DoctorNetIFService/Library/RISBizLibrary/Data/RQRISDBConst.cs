namespace RISBizLibrary.Data
{
	...
	public class RQRISDBConst
	{
		...
		/// <summary>
		/// 受信データタイプ識別子（GGNN）-オーダ更新
		/// </summary>
		public const string FROMHISINFO_MESSAGETYPE_ORDER_CHANGE = "OI02";
		...
		/// <summary>
		/// 受信データタイプ識別子（GGNN）-入院情報受信
		/// </summary>
		public const string FROMHISINFO_MESSAGETYPE_HOSPITALIZE = "PI02";

		/// <summary>
		/// 受信データタイプ識別子（GGNN）-入院情報キャンセル受信
		/// </summary>
		public const string FROMHISINFO_MESSAGETYPE_HOSPITALIZE_CANCEL = "PI03";

		/// <summary>
		/// 受信データタイプ識別子（GGNN）-転棟情報受信
		/// </summary>
		public const string FROMHISINFO_MESSAGETYPE_CHANGEWARD = "PI04";

		/// <summary>
		/// 受信データタイプ識別子（GGNN）-転科情報受信
		/// </summary>
		public const string FROMHISINFO_MESSAGETYPE_CHANGESECTION = "PI05";

		/// <summary>
		/// 受信データタイプ識別子（GGNN）-退院情報受信
		/// </summary>
		public const string FROMHISINFO_MESSAGETYPE_LEAVE_HOSPITAL = "PI99";

		/// <summary>
		/// 受信データタイプ識別子（GGNN）-退院情報受信
		/// </summary>
		public const string FROMHISINFO_MESSAGETYPE_LEAVE_HOSPITAL_CANCEL = "PI98";
		...
		public const string REQUEST_TYPE_RECEIPT            = "RC01"; //受付 (診断・治療共通)
		public const string REQUEST_TYPE_RECEIPT_CANCEL     = "RC99"; //受付キャンセル (診断・治療共通)
		public const string REQUEST_TYPE_ORDER_REQUEST      = "OR01"; //依頼再送 (診断)
		public const string REQUEST_TYPE_EXAM               = "OP01"; //実施 (診断・治療共通)
		public const string REQUEST_TYPE_EXAM_UPDATE        = "OP02"; //実施変更 (診断・治療共通)
		public const string REQUEST_TYPE_EXAM_CANCEL        = "OP99"; //実施中止 (診断)
		public const string REQUEST_TYPE_RESERVE            = "OC01"; //予約 (治療)
		public const string REQUEST_TYPE_RESERVE_UPDATE     = "OC02"; //予約変更 (治療)
		public const string REQUEST_TYPE_RESERVE_CANCEL     = "OC99"; //予約取消 (治療)
		public const string REQUEST_TYPE_PATIENT_REQUEST    = "PR01"; //患者情報要求
		public const string REQUEST_TYPE_ORDER_REQUEST_RIS  = "OR01"; //依頼再送要求（治療）
		public const string REQUEST_TYPE_RECEIPT_RIS        = "RP01"; //撮影受付（治療）
		public const string REQUEST_TYPE_RECEIPT_CANCEL_RIS = "RP98"; //撮影受付取消（治療）
		public const string REQUEST_TYPE_EXAM_RIS           = "OP31"; //放射線実施（治療）
		public const string REQUEST_TYPE_EXAM_UPDATE_RIS    = "OP32"; //放射線実施変更（治療）
		public const string REQUEST_TYPE_EXAM_CANCEL_RIS    = "OP98"; //放射線実施中止（治療）
		public const string REQUEST_TYPE_EXAM_TQ01_RIS      = "TQ01";
		public const string REQUEST_TYPE_EXAM_TQ02_RIS      = "TQ02";
