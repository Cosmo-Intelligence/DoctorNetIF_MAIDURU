...
namespace RISBizLibrary.Download.Model
{
	...
	/// メッセージからDBへ更新する
	/// </summary>
	internal class LeaveHospitalizeMsgDBSetter : BaseMsgDBSetter
	{
		#region field
		...
		/// コンストラクタ
		/// </summary>
		public LeaveHospitalizeMsgDBSetter()
			: base()
		{
		...
		{
			return new LeaveHospitalizeMsgData();
		}
		...
		{
			LeaveHospitalizeMsgData data =  (LeaveHospitalizeMsgData)msgData;

			ValidateMaster(data, cnRis);
			LeaveHospitalUpdater updater = new LeaveHospitalUpdater();
		...
		private void ValidateMaster(LeaveHospitalizeMsgData msgData, IDbConnection cn)
		{
