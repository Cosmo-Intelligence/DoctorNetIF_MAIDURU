	...
	public class HospitalUpdater
	{
		...
		private void InsertOrUpdateWithTran(BaseMsgData data, IDbConnection cn, IDbTransaction tr)
		{
			...
			using (IDbCommand command = cn.CreateCommand())
			{
				...
				PATIENTINFOUpdaterHospital patientInfoUpdater = new PATIENTINFOUpdaterHospital();
				...
				TOHISINFOUpdater toHisInfoUpdater = new TOHISINFOUpdaterHospitalize();
