...
{
	public class PATIENTINFOUpdaterChangeSection : BaseUpdater
	{
		#region const
		...
		public override void SetParams(BaseMsgData data, System.Data.IDbCommand command)
		{
			...
			ChangeSectionMsgData targetData = (ChangeSectionMsgData)data;
			ChangeSectionAggregate root = targetData.Request.MsgBody.ChangeSection;

			SetStringToCommand(PARAM_NAME_KANJA_ID, root.PT_ID.TrimData, command);

			SetStringToCommand(PARAM_NAME_SECTION_ID, root.IDO_KA_CD.TrimData, command);
		}
	}
}
