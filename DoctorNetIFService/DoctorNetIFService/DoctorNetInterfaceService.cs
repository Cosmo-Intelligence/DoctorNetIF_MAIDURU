...
{
	public partial class DoctorNetInterfaceService : ServiceBase
	{
		#region field
		/// <summary>
		/// log4netインスタンス
        ...
        public DoctorNetInterfaceService()
		{
			InitializeComponent();
		}
		...
		protected override void OnStop()
		{
			...
			int millisecondsTimeout = AppConfigController.GetInstance().GetValueString(AppConfigParameter.threadStopTimeout).StringToInt32();
